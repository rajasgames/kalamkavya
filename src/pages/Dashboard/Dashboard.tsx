          ...
          {recentScenes.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
              {recentScenes.map(scene => (
                <Card key={scene.id} hoverable className="p-5 flex flex-col cursor-pointer" onClick={() => navigate('/manuscript/editor')}>
                  <div className="flex items-start justify-between mb-3">
                    <span className="text-xs font-medium text-amber-from bg-amber-from/10 px-2 py-1 rounded">
